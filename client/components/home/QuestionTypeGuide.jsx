...
export const QUESTION_TYPE_GUIDES = {
  ...
  truefalse: {
    title: "સાચું / ખોટું પ્રશ્નો",
    body: "વાક્ય સાચું છે કે ખોટું તે પસંદ કરવાનું રહેશે. સાચું અથવા ખોટું કાર્ડ ટેપ કરીને સબમિટ બટન ક્લિક કરો. ત્યાર બાદ AI તમારો જવાબ ચેક કરશે.",
  },
  blanks: {
