...
export default function HomePage() {
  ...
  return (
    <main className="no-scrollbar animate-screen-in flex-1 overflow-x-hidden overflow-y-auto overscroll-contain bg-[#F2F2F2] pb-32">
      <section className="relative mx-1 mt-1 overflow-hidden rounded-[1.75rem]">
        ...
        <div className="relative z-10 flex flex-col px-3 pt-6 pb-1.5">
          <div className="flex flex-col items-center">
            ...
            <div className="grid size-[4.75rem] place-items-center overflow-hidden rounded-full bg-white mt-6 mb-3">
              <BrandIcon
            ...
            <h1
              className="mt-1 font-heading text-[1.5rem] leading-none font-bold tracking-tight text-white"
            >
              {appConfig.name}
            </h1>
